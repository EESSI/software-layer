...
# /cvmfs/dev.eessi.io/
if [[ ! -z ${EESSI_DEV_PROJECT} ]]; then
    echo "EESSI_DEV_PROJECT is set to ${EESSI_DEV_PROJECT}, setting EESSI_SITE_INSTALL"
    echo "Unsetting EESSI_CVMFS_INSTALL"
    unset EESSI_CVMFS_INSTALL
    export EESSI_SITE_INSTALL=$EESSI_CVMFS_REPO_OVERRIDE/versions/$EESSI_VERSION/$EESSI_DEV_PROJECT
    echo "EESSI_SITE_INSTALL set to ${EESSI_SITE_INSTALL}"
fi
